...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-csvtojson/node_modules/csvtojson/libs/core/parser.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header low">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-csvtojson/node_modules/csvtojson/libs/core/parser.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-csvtojson/node_modules/csvtojson/libs/core/</a> &#187; parser.js</div>
</div>
<div class="body">
...
<span class="cline-any cline-yes">1</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span></td><td class="text"><pre class="prettyprint lang-js">var explicitTypes = ["number", "string"];
&nbsp;
function Parser(name, regExp, parser, processSafe) {
  this.name = typeof name === "undefined" ? <span class="branch-0 cbranch-no" title="branch not covered" >"Default" </span>: name;
  this.regExp = null;
  this.type = "";
  this.processSafe = processSafe;
  <span class="missing-if-branch" title="else path not taken" >E</span>if (typeof regExp !== "undefined") {
    <span class="missing-if-branch" title="if path not taken" >I</span>if (typeof regExp === "string") {
<span class="cstat-no" title="statement not covered" >      this.regExp = new RegExp(regExp);</span>
    } else {
      this.regExp = regExp;
    }
  }
  <span class="missing-if-branch" title="else path not taken" >E</span>if (typeof parser !== "undefined") {
    this.parse = parser;
  }
}
// var numReg = /^[-+]?[0-9]*\.?[0-9]+([eE][-+]?[0-9]+)?$/;
Parser.prototype.convertType = <span class="fstat-no" title="function not covered" >function(item) {</span>
...
Parser.prototype.setParam = <span class="fstat-no" title="function not covered" >function(param) {</span>
<span class="cstat-no" title="statement not covered" >  this.param = param;</span>
}
Parser.prototype.test = <span class="fstat-no" title="function not covered" >function(str) {</span>
<span class="cstat-no" title="statement not covered" >  return this.regExp &amp;&amp; this.regExp.test(str);</span>
};
Parser.prototype.parse = <span class="fstat-no" title="function not covered" >function(params) {</span>
<span class="cstat-no" title="statement not covered" >  params.resultRow[params.head] = params.item;</span>
};
Parser.prototype.getHeadStr = <span class="fstat-no" title="function not covered" >function() {</span>
...
Parser.prototype.getHead = <span class="fstat-no" title="function not covered" >function() {</span>
<span class="cstat-no" title="statement not covered" >  return this.head;</span>
};
Parser.prototype.initHead = <span class="fstat-no" title="function not covered" >function(columnTitle) {</span>
<span class="cstat-no" title="statement not covered" >  this.head = columnTitle;</span>
<span class="cstat-no" title="statement not covered" >  var wholeHead = columnTitle.replace(this.regExp, '');</span>
  //init type &amp;&amp; headStr
<span class="cstat-no" title="statement not covered" >  var splitArr = wholeHead.split("#!");</span>
...
<span class="cstat-no" title="statement not covered" >    var type = splitArr.shift();</span>
...
Parser.prototype.clone = <span class="fstat-no" title="function not covered" >function() {</span>
<span class="cstat-no" title="statement not covered" >  var obj = Object.create(this);</span>
<span class="cstat-no" title="statement not covered" >  var newParser = new Parser();</span>
