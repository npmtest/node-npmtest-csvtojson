...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-csvtojson/node_modules/csvtojson/libs/core/CSVError.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header low">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-csvtojson/node_modules/csvtojson/libs/core/CSVError.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-csvtojson/node_modules/csvtojson/libs/core/</a> &#187; CSVError.js</div>
</div>
<div class="body">
...
<span class="fstat-no" title="function not covered" >function CSVError(err,index,extra){</span>
...
&nbsp;
CSVError.prototype.toString=<span class="fstat-no" title="function not covered" >function(){</span>
<span class="cstat-no" title="statement not covered" >  return JSON.stringify([this.err,this.line,this.extra]);</span>
}
&nbsp;
CSVError.column_mismatched=<span class="fstat-no" title="function not covered" >function(index,extra){</span>
<span class="cstat-no" title="statement not covered" >  return new CSVError("column_mismatched",index,extra);</span>
}
&nbsp;
CSVError.unclosed_quote=<span class="fstat-no" title="function not covered" >function(index,extra){</span>
<span class="cstat-no" title="statement not covered" >  return new CSVError("unclosed_quote",index,extra);</span>
}
&nbsp;
CSVError.fromArray=<span class="fstat-no" title="function not covered" >function(arr){</span>
