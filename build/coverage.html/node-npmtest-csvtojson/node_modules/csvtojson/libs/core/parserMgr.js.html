...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-csvtojson/node_modules/csvtojson/libs/core/parserMgr.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header low">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-csvtojson/node_modules/csvtojson/libs/core/parserMgr.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-csvtojson/node_modules/csvtojson/libs/core/</a> &#187; parserMgr.js</div>
</div>
<div class="body">
...
function registerParser (parser) {
  <span class="missing-if-branch" title="else path not taken" >E</span>if (parser instanceof Parser &amp;&amp; registeredParsers.indexOf(parser) === -1) {
    registeredParsers.push(parser); // TODO indexOf doesn't work with object references
  }
}
<span class="fstat-no" title="function not covered" >function getParser (columnTitle, param) {</span>
<span class="cstat-no" title="statement not covered" >  var inst, parser;</span>
<span class="fstat-no" title="function not covered" >  function getParserByName (parserName) {</span>
<span class="cstat-no" title="statement not covered" >    var parser;</span>
<span class="cstat-no" title="statement not covered" >    registeredParsers.forEach(<span class="fstat-no" title="function not covered" >function(p){</span></span>
...
<span class="cstat-no" title="statement not covered" >      var inst = parser.clone();</span>
...
<span class="fstat-no" title="function not covered" >function addSafeParser(parserPath){</span>
  //TODO impl
}
&nbsp;
<span class="fstat-no" title="function not covered" >function initParsers (row, param) {</span>
<span class="cstat-no" title="statement not covered" >  var parsers = [];</span>
<span class="cstat-no" title="statement not covered" >  row.forEach(<span class="fstat-no" title="function not covered" >function (columnTitle) {</span></span>
