...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-csvtojson/node_modules/csvtojson/libs/core/defaultParsers/parser_json.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header low">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-csvtojson/node_modules/csvtojson/libs/core/defaultParsers/parser_json.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../../../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-csvtojson/node_modules/csvtojson/libs/core/defaultParsers/</a> &#187; parser_json.js</div>
</div>
<div class="body">
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span></td><td class="text"><pre class="prettyprint lang-js">var arrReg = /\[([0-9]*)\]/;
&nbsp;
&nbsp;
<span class="fstat-no" title="function not covered" >function processHead(pointer, headArr, arrReg, flatKeys) {</span>
<span class="cstat-no" title="statement not covered" >  var headStr, match, index;</span>
...
module.exports = {
  ...
  "processSafe": true,
  "regExp": /^\*json\*/,
  "parserFunc": <span class="fstat-no" title="function not covered" >function parser_json(params) {</span>
<span class="cstat-no" title="statement not covered" >    var fieldStr = this.getHeadStr();</span>
<span class="cstat-no" title="statement not covered" >    var headArr = (params.config &amp;&amp; params.config.flatKeys) ? [fieldStr] : fieldStr.split('.');</span>
<span class="cstat-no" title="statement not covered" >    var match, index, key, pointer;</span>
    //now the pointer is pointing the position to add a key/value pair.
<span class="cstat-no" title="statement not covered" >    var pointer = processHead(params.resultRow, headArr, arrReg, params.config &amp;&amp; params.config.flatKeys);</span>
